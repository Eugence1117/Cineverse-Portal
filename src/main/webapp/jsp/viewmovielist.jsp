			...
			<div id="content">
				 ...
				 <div class="container-fluid">
				 	<div class="d-sm-flex align-items-center justify-content-between mb-4">
			        	<h1 class="h3 mb-0 text-gray-800">View Movies</h1>
			        	<a href="viewMovie.htm?pages=Single" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-exchange-alt fa-sm text-white-50"></i> Change View</a>
			        </div>
			        ...
			        <div class="card m-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="movieList" class="table table-bordered" style="width:100% !important">
									<thead>
										<tr>
											<th>Movie ID</th>
											<th>Movie Name</th>
